    ...
    def addCarToQueue(self, matesInCellPosition) -> None:
        ...
        for agentIndex in range(0, len(matesInCellPosition)):
            ...
            if type(agent) == type(self.driversSample):
                ...
                elif self.direction == "south": self.queue.append((agent, (agent.velocity * (agentY - self.pos[1]))))
                elif self.direction == "west": self.queue.append((agent, (agent.velocity * (agentX - self.pos[0]))))
